...
def admin_catalog_back(request):
    if request.method=='GET':
        ...
        return render(request, 'mbooks/my_admin/catalog.html', {'books_json':books_json})
    ...
    if request.method=='POST':
        ...
        return render(request, 'mbooks/my_admin/catalog.html', {'books_json':books_json, 'searched':{'query':searchstr}})
