...
from .scripts.admin.admin_logout import *
from .scripts.admin.admin_orders import *
from .scripts.admin.admin_catalog import *
from .scripts.admin.admin_add_book import *
from .scripts.admin.admin_book import *
from .scripts.admin.admin_edit_tags import *
